...
RecommendationSystem::RecommendationSystem(int** m, int** s, int users, int movies, int shows) {
        userMovieRatingsMatrix = m;
        userShowRatingsMatrix = s ;
		numUsers = users;
		numMovies = movies;
		numShows = shows;
}
...
int** RecommendationSystem::getUserMovieRatingsMatrix() const {
    return userMovieRatingsMatrix;
}

void RecommendationSystem::setUserMovieRatingsMatrix(int** matrix) {
    userMovieRatingsMatrix = matrix;
}

// Getter and Setter for userShowRatingsMatrix
int** RecommendationSystem::getUserShowRatingsMatrix() const {
    return userShowRatingsMatrix;
}

void RecommendationSystem::setUserShowRatingsMatrix(int** matrix) {
    userShowRatingsMatrix = matrix;
}
